...
var galleryContainer = _refs.default.galleryContainer,
    modal = _refs.default.modal,
    closeModalBtn = _refs.default.closeModalBtn,
    modalContentImg = _refs.default.modalContentImg; // creates markup string from data array

function createItems(array) {
  return array.map(function (arrayElement) {
    var preview = arrayElement.preview,
        original = arrayElement.original,
        description = arrayElement.description;
    return "\n            <li class=\"gallery__item\">\n               <div class=\"gallery__link\">\n                  <img class=\"gallery__image\" src=\"".concat(preview, "\" alt=\"").concat(description, "\" data-fullimage=\"").concat(original, "\">\n               </div>\n            </li>\n            ");
  }).join('');
}

var galleryItems = createItems(_data.default); // inserts markup in DOM

galleryContainer.insertAdjacentHTML('afterbegin', galleryItems); // declares open image functon
...
closeModalBtn.addEventListener("click", closeModalByClick); // removes event listeners from modal and window when the modal window is closed
...
var imagesArray = _data.default.map(function (element) {
...
window.addEventListener("keydown", function (e) {
  ...
  if (e.code === "ArrowRight" && modal.classList.contains("is-open")) {
    ...
    modalContentImg.src = imagesArray[currentImageIndex + 1]; // checks if the current image from an array is the first available one and on ArrowLeft click restarts the order from the end of the array
    ...
    currentImageIndex = imagesArray.indexOf(modalContentImg.src);
    modalContentImg.src = imagesArray[currentImageIndex - 1]; // checks if the current image from an array is actually the last available one and resets the order for the next image on ArrowRight click to start it from the very beginning
...
},{"./data.js":"js/data.js","./refs.js":"js/refs.js"}],"index.js":[function(require,module,exports) {
"use strict";

require("./js/script");
},{"./js/script":"js/script.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
